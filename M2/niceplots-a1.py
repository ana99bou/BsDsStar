...
nsq0=pd.read_csv('./A1/A1-nsq0.txt',sep=' ',header=None)
nsq1=pd.read_csv('./A1/A1-nsq1.txt',sep=' ',header=None)
nsq2=pd.read_csv('./A1/A1-nsq2.txt',sep=' ',header=None)
nsq4=pd.read_csv('./A1/A1-nsq4.txt',sep=' ',header=None)
nsq5=pd.read_csv('./A1/A1-nsq5.txt',sep=' ',header=None)

nsq0plt=pd.read_csv('./Fits/A1-Av-nsq0-Fit.csv',sep='\s')
nsq1plt=pd.read_csv('./Fits/A1-Av-nsq1-Fit.csv',sep='\s')
nsq2plt=pd.read_csv('./Fits/A1-Av-nsq2-Fit.csv',sep='\s')
nsq4plt=pd.read_csv('./Fits/A1-Av-nsq4-Fit.csv',sep='\s')
nsq5plt=pd.read_csv('./Fits/A1-Av-nsq5-Fit.csv',sep='\s')
...
plt.errorbar(list(range(26)), nsq0[0][0:26], yerr=nsq0[1][0:26],ls='none',fmt='x',label='$n^2=0$',color='g')
