...
nsq1=pd.read_csv('./A2/A2-nsq1.txt',sep=' ',header=None)
nsq2=pd.read_csv('./A2/A2-nsq2.txt',sep=' ',header=None)
nsq3=pd.read_csv('./A2/A2-nsq3.txt',sep=' ',header=None)
nsq4=pd.read_csv('./A2/A2-nsq4.txt',sep=' ',header=None)
nsq5=pd.read_csv('./A2/A2-nsq5.txt',sep=' ',header=None)

#nsq0plt=pd.read_csv('./Fits/hA1-Av-nsq0-Fit.csv',sep='\s')
nsq1plt=pd.read_csv('./Fits/A2-Av-nsq1-Fit.csv',sep='\s')
nsq2plt=pd.read_csv('./Fits/A2-Av-nsq2-Fit.csv',sep='\s')
nsq3plt=pd.read_csv('./Fits/A2-Av-nsq3-Fit.csv',sep='\s')
nsq4plt=pd.read_csv('./Fits/A2-Av-nsq4-Fit.csv',sep='\s')
nsq5plt=pd.read_csv('./Fits/A2-Av-nsq5-Fit.csv',sep='\s')
...
plt.axis((0,26,0.09,0.18))


#plt.yscale('log')
plt.legend()
plt.savefig('Niceplot-A2.pdf',transparent=True)
