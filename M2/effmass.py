...
bsn0=f["/cl_SM10.36_SM10.36_0.025/c0.340/operator_GammaX/n2_5/data"]
bsn0y=f["/cl_SM10.36_SM10.36_0.025/c0.340/operator_GammaY/n2_5/data"]
bsn0z=f["/cl_SM10.36_SM10.36_0.025/c0.340/operator_GammaZ/n2_5/data"]
...
miry = np.zeros(shape=(889, 33))
mirz = np.zeros(shape=(889, 33))
for k in range(889):
...
plt.yscale('log')
plt.savefig('Zoom-Ds340-Reg-5.pdf')
...
df3['RegUp']=reg_up
df3['RegLow']=reg_low    
df3.to_csv('Ds340Result-5.csv', sep='\t')
