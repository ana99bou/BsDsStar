...
nsq0plt=pd.read_csv('./Ds400Result-0.csv',sep='\s')
nsq1plt=pd.read_csv('./Ds400Result-1.csv',sep='\s')
nsq2plt=pd.read_csv('./Ds400Result-2.csv',sep='\s')
nsq3plt=pd.read_csv('./Ds400Result-3.csv',sep='\s')
nsq3plt=pd.read_csv('./Ds400Result-3.csv',sep='\s')
nsq4plt=pd.read_csv('./Ds400Result-4.csv',sep='\s')
nsq5plt=pd.read_csv('./Ds400Result-5.csv',sep='\s')

x0, y0 = [1, 30], [nsq0plt['EffectiveMass'], nsq0plt['EffectiveMass']]
x1, y1 = [1, 30], [nsq1plt['EffectiveMass'], nsq1plt['EffectiveMass']]
x2, y2 = [1, 30], [nsq2plt['EffectiveMass'], nsq2plt['EffectiveMass']]
x3, y3 = [1, 30], [nsq3plt['EffectiveMass'], nsq3plt['EffectiveMass']]
x4, y4 = [1, 30], [nsq4plt['EffectiveMass'], nsq4plt['EffectiveMass']]
x5, y5 = [1, 30], [nsq5plt['EffectiveMass'], nsq5plt['EffectiveMass']]
...
plt.errorbar(list(range(30)), nsq0['EffectiveMass'], yerr=nsq0['Error'],ls='none',fmt='x',label='$n^2=0$',color='g')
plt.errorbar(list(range(30)), nsq1['EffectiveMass'], yerr=nsq1['Error'],ls='none',fmt='x',label='$n^2=1$',color='b')
plt.errorbar(list(range(30)), nsq2['EffectiveMass'], yerr=nsq2['Error'],ls='none',fmt='x',label='$n^2=2$',color='orange')
plt.errorbar(list(range(30)), nsq3['EffectiveMass'], yerr=nsq3['Error'],ls='none',fmt='x',label='$n^2=3$',color='brown')
plt.errorbar(list(range(30)), nsq4['EffectiveMass'], yerr=nsq4['Error'],ls='none',fmt='x',label='$n^2=4$',color='red')
plt.errorbar(list(range(30)), nsq5['EffectiveMass'], yerr=nsq5['Error'],ls='none',fmt='x',label='$n^2=5$',color='cyan')
